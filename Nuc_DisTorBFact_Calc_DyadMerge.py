#C:\Users\basti\AppData\Local\Programs\Python\Python39\Structural_Files\structural_analysis_calculations\S_Pombe\Mcm1
#res cut-off: 3.50
...
if PP_type1 == 1:
    ...
    for filename in os.listdir(directory):
        if filename.endswith(".tsv"):
            ...
            offset_file = open("motif_offsets_all3p5.txt")
    ...
    intdis_inttor.sort()
    with open("Nuc_CPD_distance_angle_all_res3p50.txt", "w+") as f:
        f.write("Distance" + '\n')
        i = 0.5
        while i <= 73.5:
            f.write(str(i) + '\t')
            for line in dipy_distor:
                if line[0] == i or line[0] == (-1 * i):
                    f.write(str(line[1]) + '\t')
            f.write('\n')
            i = i + 1
        ...
        while i <= 73.5:
            ...
            i = i + 1
    f.close()
    with open("Nuc_CPD_distance_angle_all_res3p50_BaWP.txt", "w+") as f:
        for line in dipy_distor:
            f.write(str(line[0]) + '\t' + str(line[1]) + '\t' + str(line[2]) + '\n')
    f.close()
    with open("Nuc_CPD_distance_angle_all_res3p50_cats.txt", "w+") as f:
